...
<htmL>
	...
	<body>
		...
		<p>The site assigned was Starbucks web page. The user is a 26 year old 	college 	student who loves coffee. The site 			is designed to purchase Starbucks products.  The purpose would be the coffee drinker to buy her favorite coffee and 			to rate the particular coffee an integer from 1-5, having 5 being the highest and most favorite. </p>
		<h1>Use Case</h1>
		...
		<ol>
			...
			<li>Why: The coffee drinker rates her most favorite coffee, and from there forms an entity for coffee. It reflects 				off of the customers persona as a coffee lover and shows she wants something 	fast and easy.</li>
		</ol>

		<h1>Interaction Flow</h1>
		<p>The goal would the female buyer who chooses to rate her favorite product. The logical containers would involve: customer, order and product, and vendor.  The user would start off in the following steps to purchase the coffee of choice:</p>
		<ol>
			<li>
				Entering URL site
			</li>
			...
			<li>
				Selecting from category the coffee product of choice.
			</li>
