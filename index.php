...
<htmL>
	...
	<body>
		...
		<ol>
			...
			<li>Who: Customer who loves coffee and needs it daily to function. Her favorite coffee type form of choice for coffee maker.</li>
			<li>Why: She want to buy her favorite tasting house blend coffee. It reflects off of the customers persona as a coffee lover.</li>
		</ol>
		<h1>Interaction Flow</h1>
		<p>The goal would be to satisfy the customer and mapping out the data at rest. The logical containers would involve: customer, order and product, and vendor.  The user would start off in the following steps to purchase the coffee of choice:</p>
		<ol>
			<li>
				Entering URL site
			</li>
		...
		<p>
			...
			<li>Choice of decaffeinated or caffeinated type.</li>
			<li>
